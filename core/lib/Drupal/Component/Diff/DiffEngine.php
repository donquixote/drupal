...
class DrupalDiffFormatter extends DiffFormatter {
  ...
  function DrupalDiffFormatter() {
    $this->leading_context_lines = Settings::requireSingleton()->get('diff_context_lines_leading', 2);
    $this->trailing_context_lines = Settings::requireSingleton()->get('diff_context_lines_trailing', 2);
  }
