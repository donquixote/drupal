...
class ExtensionListBuilder {
  ...
  /**
   * @param \Drupal\Core\Extension\FileToInfo\FileToInfoInterface $fileToInfo
   *
   * @return static
   */
  public function withFileToInfo(FileToInfoInterface $fileToInfo) {
    return $this->withFilesToInfo(new FilesToInfo_FileToInfo($fileToInfo));
  }

  /**
   * @param \Drupal\Core\Extension\FilesToInfo\FilesToInfoInterface $fileToInfo
   *
   * @return static
   */
