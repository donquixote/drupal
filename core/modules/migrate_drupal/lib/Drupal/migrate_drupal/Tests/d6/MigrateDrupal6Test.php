...
class MigrateDrupal6Test extends MigrateDrupalTestBase {
  ...
  public function testDrupal6() {
    ...
    $dumps = array(
      $tests_path . '/Dump/Drupal6ActionSettings.php',
      $tests_path . '/Dump/Drupal6AggregatorFeed.php',
      $tests_path . '/Dump/Drupal6AggregatorItem.php',
      $tests_path . '/Dump/Drupal6AggregatorSettings.php',
      $tests_path . '/Dump/Drupal6Block.php',
      $tests_path . '/Dump/Drupal6BookSettings.php',
      $tests_path . '/Dump/Drupal6Box.php',
      $tests_path . '/Dump/Drupal6Comment.php',
      $tests_path . '/Dump/Drupal6CommentVariable.php',
      $tests_path . '/Dump/Drupal6ContactCategory.php',
      $tests_path . '/Dump/Drupal6ContactSettings.php',
      $tests_path . '/Dump/Drupal6DateFormat.php',
      $tests_path . '/Dump/Drupal6DblogSettings.php',
      $tests_path . '/Dump/Drupal6FieldInstance.php',
      $tests_path . '/Dump/Drupal6FieldSettings.php',
      $tests_path . '/Dump/Drupal6File.php',
      $tests_path . '/Dump/Drupal6FileSettings.php',
      $tests_path . '/Dump/Drupal6FilterFormat.php',
      $tests_path . '/Dump/Drupal6ForumSettings.php',
      $tests_path . '/Dump/Drupal6LocaleSettings.php',
      $tests_path . '/Dump/Drupal6Menu.php',
      $tests_path . '/Dump/Drupal6MenuSettings.php',
      $tests_path . '/Dump/Drupal6NodeBodyInstance.php',
      $tests_path . '/Dump/Drupal6Node.php',
      $tests_path . '/Dump/Drupal6NodeRevision.php',
      $tests_path . '/Dump/Drupal6NodeSettings.php',
      $tests_path . '/Dump/Drupal6NodeType.php',
      $tests_path . '/Dump/Drupal6SearchPage.php',
      $tests_path . '/Dump/Drupal6SearchSettings.php',
      $tests_path . '/Dump/Drupal6SimpletestSettings.php',
      $tests_path . '/Dump/Drupal6StatisticsSettings.php',
      $tests_path . '/Dump/Drupal6SyslogSettings.php',
      $tests_path . '/Dump/Drupal6SystemCron.php',
      // This dump contains the file directory path to the simpletest directory
      // where the files are.
      $tests_path . '/Dump/Drupal6SystemFile.php',
      $tests_path . '/Dump/Drupal6SystemFilter.php',
      $tests_path . '/Dump/Drupal6SystemImageGd.php',
      $tests_path . '/Dump/Drupal6SystemImage.php',
      $tests_path . '/Dump/Drupal6SystemMaintenance.php',
      $tests_path . '/Dump/Drupal6SystemPerformance.php',
      $tests_path . '/Dump/Drupal6SystemRss.php',
      $tests_path . '/Dump/Drupal6SystemSite.php',
      $tests_path . '/Dump/Drupal6SystemTheme.php',
      $tests_path . '/Dump/Drupal6TaxonomySettings.php',
      $tests_path . '/Dump/Drupal6TaxonomyTerm.php',
      $tests_path . '/Dump/Drupal6TaxonomyVocabulary.php',
      $tests_path . '/Dump/Drupal6TermNode.php',
      $tests_path . '/Dump/Drupal6TextSettings.php',
      $tests_path . '/Dump/Drupal6UpdateSettings.php',
      $tests_path . '/Dump/Drupal6UploadInstance.php',
      $tests_path . '/Dump/Drupal6Upload.php',
      $tests_path . '/Dump/Drupal6UrlAlias.php',
      $tests_path . '/Dump/Drupal6UserMail.php',
      $tests_path . '/Dump/Drupal6User.php',
      $tests_path . '/Dump/Drupal6UserProfileFields.php',
      $tests_path . '/Dump/Drupal6UserRole.php',
      $tests_path . '/Dump/Drupal6VocabularyField.php',
    );
